...
$iflynepal_intro      = iflynepal_package_field( $iflynepal_id, 'overview_intro' );
$iflynepal_body       = iflynepal_package_paragraphs( iflynepal_package_field( $iflynepal_id, 'overview_body' ) );
$iflynepal_highlights = iflynepal_package_field_lines( $iflynepal_id, 'highlights' );

if ( '' === $iflynepal_intro && empty( $iflynepal_body ) && empty( $iflynepal_highlights ) ) {
	return;
}
?>
...
<section class="iflynepal-pkg-t-section" id="ifnpkg-overview" aria-label="<?php esc_attr_e( 'Overview', 'iflynepal' ); ?>">
	<?php if ( '' !== $iflynepal_intro ) : ?>
		<p class="iflynepal-pkg-intro" data-iflynepal-anim><?php echo esc_html( $iflynepal_intro ); ?></p>
	<?php endif; ?>
	...
	<?php if ( ! empty( $iflynepal_body ) ) : ?>
		<div class="iflynepal-pkg-prose iflynepal-pkg-prose--after" data-iflynepal-anim>
			<?php foreach ( $iflynepal_body as $iflynepal_paragraph ) : ?>
				<p><?php echo esc_html( $iflynepal_paragraph ); ?></p>
			<?php endforeach; ?>
		</div>
	<?php endif; ?>
			...
			<ul class="iflynepal-pkg-check-list">
				<?php foreach ( $iflynepal_highlights as $iflynepal_highlight ) : ?>
					<li>
						...
						<?php echo esc_html( $iflynepal_highlight ); ?>
					</li>
				<?php endforeach; ?>
			</ul>
		</div>
